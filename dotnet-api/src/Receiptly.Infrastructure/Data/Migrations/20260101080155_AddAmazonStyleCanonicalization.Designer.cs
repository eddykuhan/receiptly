...
namespace Receiptly.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260101080155_AddAmazonStyleCanonicalization")]
    partial class AddAmazonStyleCanonicalization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Receiptly.Domain.Models.CanonicalItem", b =>
                {
                    ...
                    b.PrimitiveCollection<string[]>("NameTokens")
                        .HasColumnType("text[]");
                    ...
                    b.Property<decimal?>("SizeNormalized")
                    ...
                    b.HasIndex("NameTokens")
                        .HasDatabaseName("idx_canonical_items_tokens")
                        .HasFilter("\"IsMaster\" = TRUE");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("NameTokens"), "gin");

                    b.HasIndex("SizeNormalized", "SizeUnit")
                        .HasDatabaseName("idx_canonical_items_size")
                        .HasFilter("\"IsMaster\" = TRUE AND \"SizeNormalized\" IS NOT NULL");

                    b.HasIndex("Brand", "SizeNormalized", "Category")
            ...
            modelBuilder.Entity("Receiptly.Domain.Models.CanonicalItem", b =>
                {
                    b.HasOne("Receiptly.Domain.Models.CanonicalItem", "MasterItem")
                        .WithMany("ChildItems")
