...
# Policy for S3 access (for receipt storage)
resource "aws_iam_policy" "s3_access" {
  name        = "${var.project_name}-${var.environment}-s3-access"
  description = "Allow ECS tasks to read/write to S3 bucket"
...
# Allow task to read secrets at runtime (in addition to task execution role)
